...
<head>
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/dog_shopping/css/cartList.css">
	<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
	<script src="<%=request.getContextPath()%>/dog_shopping/js/cartList.js"></script>
</head>
<body>
	...
	<section id="listForm">
				...
				<table>
					...
					<c:forEach var="cart" items="${cartList }" varStatus="status">
						<tr>
							...
							<td>
								<img src="<%=request.getContextPath()%>/dog_shopping/img/${cart.image}" id="cartImage">
							</td>
							<td>
								${cart.kind }
							</td>
							...
							<td>
								<a href="dogCartQtyUp.do?kind=${cart.kind }">
									<img src="<%=request.getContextPath()%>/dog_shopping/img/up.jpg" id="upImage" border=0>
								</a> <br>
								${cart.qty } <br>
								<a href="javascript:checkQty('${cart.kind }', ${cart.qty })">
								<img src="<%=request.getContextPath()%>/dog_shopping/img/down.jpg" id="downImage" border=0>
								</a>
							</td>
						</tr>
					</c:forEach>
		...
		<nav id="commandList">
			<br>
			<br>
			<a href="dogList.do"><button>쇼핑 계속하기</button></a>
			<br>
			<br> 
		</nav>
	</section>
